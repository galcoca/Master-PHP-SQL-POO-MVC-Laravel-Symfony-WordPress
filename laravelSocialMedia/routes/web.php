...
Route::prefix('/')->group(function () {
    ...
    Route::get('/imagepost/{filename}', [HomeController::class, 'getImage'])->name('home.images');
});

Route::prefix('post')->group(function () {
    Route::get('/detail/{id}', [PostController::class, 'detail'])->name('post.detail');
    Route::get('/liked', [PostController::class, 'liked'])->name('post.liked');
...
Route::post('/dislike', [LikeController::class, 'dislike'])->name('like.dislike');